...
const KangarooSubmissions = () => {
  ...
  return (
    <Container>
      <Head>
        <title>SPECTRA STORAGE MARKETS</title>
      </Head>
      <Header />
      <div className="flex flex-col items-start w-full max-w-4xl gap-10 px-8 mb-20 overflow-hidden">
        <h1 className="text-2xl text-brand-400">SPECTRA MARKETS</h1>
        ...
        <p className="mt-8 text-2xl font-light text-kggrey-200"></p>
        <button className="mt-2 font-medium text-left uppercase text-white/80 hover:text-white"></button>
        <Dialog
          open={isOpen}
